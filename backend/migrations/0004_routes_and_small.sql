...
-- Backfills existing rows with the 'Desna' route. Change if your default differs.
...
UPDATE slots SET route_name = 'Desna' WHERE route_name IS NULL;
...
UPDATE bookings SET route_name = 'Desna' WHERE route_name IS NULL;
